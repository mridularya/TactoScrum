<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_review.aspx.cs" Inherits="scrum.view_review" %>
...
<body style="background-color: #EEEEEE">
    <form id="form1" runat="server">
        <div class="jumbotron-fluid text-center" style="background-image: linear-gradient(to left, #233857, #0a4f6e, #00667d, #007e83, #299481); height:90px">
            <div class="row">
             ...
             <img src="assets/agile_agile-02-512.png" alt="na" height="80px" style="margin-left:500px"/>
                ...
                <div>
            <h1 style="color:white;margin-top:20px">Reviews</h1>
                    </div>
        </div>
            </div>
        <br />
        ...
        <div class="container-fluid">
              <div>
            <asp:Button Text="Create New" ID="Mkreview" runat="server" CssClass="btn btn-primary" OnClick="Mkreview_Click" style="float:right" /> 
