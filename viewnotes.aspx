<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewnotes.aspx.cs" Inherits="scrum.viewnotes" %>
...
<body style="background-image: linear-gradient(to left, #233857, #0a4f6e, #00667d, #007e83, #299481);">
    <form id="form1" runat="server">
        <div class="jumbotron-fluid text-center" style="background-image: linear-gradient(to left, #233857, #0a4f6e, #00667d, #007e83, #299481); height:90px">
            <div class="row">
             ...
             <img src="assets/agile_agile-02-512.png" alt="na" height="80px" style="margin-left:500px"/>
                ...
                <div>
            <h1 style="color:white;margin-top:20px">Notes</h1>
                    </div>
        </div>
            </div>
        <br />
        ...
        <div class="container-fluid">
              <div>
            <asp:Button Text="Create New" ID="Createnotes" runat="server" CssClass="btn btn-primary" OnClick="Createnotes_Click" style="float:right" /> 
       ...
       <asp:GridView  ID="gv1" runat="server" BackColor="white"  BorderColor="#000000"  CellPadding="4" GridLines="Both" BorderWidth="1px" ForeColor="black" CssClass="footable" Width="100%" Height="100%">
           <RowStyle HorizontalAlign="Center" />
            ...
            <HeaderStyle BackColor="#000000" Font-Bold="True" HorizontalAlign="Center" ForeColor="white" Width="20px" />
