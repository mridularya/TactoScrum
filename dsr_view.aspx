<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dsr_view.aspx.cs" Inherits="scrum.dsr_view" %>
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.8.2/js/mdb.min.js"></script>
    <title>Dev Specific Instructions</title>
    <style>
        .allignment {
            margin-top: 400px;
        }
...
<body style="background-color:#EEEEEE;">
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
               <div>
            <asp:Button Text="Create New" ID="CreateInstruction" runat="server" CssClass="btn btn-primary" OnClick="CreateInstruction_Click" style="float:right" /> 
