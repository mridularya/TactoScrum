<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sprint backlog.aspx.cs" Inherits="scrum.sprint_backlog" %>
...
<body style="background-color:#EEEEEE">
    <form id="form1" runat="server">
        ...
        <div class="jumbotron-fluid text-center" style="background-image: linear-gradient(to left, #233857, #0a4f6e, #00667d, #007e83, #299481); height:90px">
            <div class="row">
             ...
             <img src="assets/agile_agile-02-512.png" alt="na" height="80px" style="margin-left:500px"/>
                ...
                <div>
            <h1 style="color:white;margin-top:20px">Task Entry</h1>
                    </div>
        </div>
            </div>
           
            <div class="row">
         <h3 class="allignment col-4">Sprint :</h3>
        <asp:DropDownList ID="Dd2" runat="server" CssClass="form-control allignment col-4" OnSelectedIndexChanged="Dd2_SelectedIndexChanged" AutoPostBack="true">
                 
        </asp:DropDownList>
                </div>
            <div class="row">
         <h3 class="allignment col-4">feature :</h3>
        <asp:DropDownList ID="Dd3" runat="server" CssClass="form-control allignment col-4">
        </asp:DropDownList>
           </div>
        <div class="row">
         <h3 class="allignment col-4">Task Name :</h3>

        <asp:TextBox  runat="server" CssClass="form-control col-4 allignment" id="TbHeader" type="text" AutoCompleteType="Disabled"></asp:TextBox>
            </div>
       ...
       <div class="row">
        ...
        <asp:TextBox runat="server" CssClass="form-control col-4 allignment" id="date2" name="date" placeholder="MM/DD/YYY" type="text" AutoCompleteType="Disabled"></asp:TextBox>
        ...
        <asp:DropDownList ID="Dd4" runat="server" CssClass="form-control  col-4 allignment">
            ...
            <div class="row">
        <h3 class="allignment col-4">Status :</h3>
        <asp:DropDownList ID="Dd5" runat="server" CssClass="form-control allignment col-4">
