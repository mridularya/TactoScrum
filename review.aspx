<%@ Page Language="C#" AutoEventWireup="true" CodeFile="review.aspx.cs" Inherits="scrum.review" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ScriptManager runat="server" ID="scriptManager"></asp:ScriptManager>
                ...
                <h1 class="text-center jumbotron " style="color: #EEEEEE ; background-color:#252958">Daily Review</h1>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <asp:DropDownList ID="Dd2" runat="server" CssClass="form-control col-4 allignment" OnSelectedIndexChanged="Dd2_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                    <div class="row">
