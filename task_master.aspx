<%@ Page Language="C#" AutoEventWireup="true" CodeFile="task_master.aspx.cs" Inherits="scrum.task_master" EnableEventValidation="false" %>
...
<body style="background-color:#EEEEEE" >
    ...
    <form id="form1" runat="server">  
       <div class="container-fluid">
            <div>
            <asp:Button Text="Create New" ID="CreateTask" runat="server" CssClass="btn btn-primary" OnClick="CreateTask_Click" style="float:right" /> 
                <asp:Button Text="Back" ID="back" runat="server" CssClass="btn btn-sm btn-primary" style="float:left" OnClick="Bkbtn_Click" />
                </div>
...
OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" CssClass="footable">  
            ...
            <Columns>  
                ...
                <asp:TemplateField HeaderText="Backlog">  
                    <ItemTemplate>  
                        <asp:Label ID="d_name" runat="server" Text='<%#Eval("[Developer]") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>  
                <asp:TemplateField HeaderText="Sprint">  
                    <ItemTemplate>  
                        <asp:Label ID="sprint" runat="server" Text='<%#Eval("[sprint number]") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>
                 <asp:TemplateField HeaderText="Task">  
                    <ItemTemplate>  
                        <asp:Label ID="Theader" runat="server" Text='<%#Eval("[task Header]") %>'></asp:Label>  
                    </ItemTemplate>    
                     </asp:TemplateField>
                  <asp:TemplateField HeaderText="Feature">  
                    <ItemTemplate>  
                        <asp:Label ID="feat" runat="server" Text='<%#Eval("[feature]") %>'></asp:Label>  
                    </ItemTemplate>   
                </asp:TemplateField>  
                <asp:TemplateField HeaderText="Creation Date">  
                    <ItemTemplate>  
                        <asp:Label ID="cd" runat="server" Text='<%#Eval("[start date]") %>'></asp:Label>  
                    </ItemTemplate>   
                </asp:TemplateField>  
                
                <asp:TemplateField HeaderText="Deadline">  
                    <ItemTemplate>  
                        <asp:Label ID="dline" runat="server" Text='<%#Eval("[deadline]") %>'></asp:Label>  
                    </ItemTemplate>   
                </asp:TemplateField>  
                ...
                <asp:TemplateField HeaderText="Priority">  
                    ...
                    <EditItemTemplate>  
                        <asp:DropDownList ID="e_pr" runat="server" Text='<%#Eval("priority") %>'>
                 ...
                 <asp:TemplateField HeaderText="Status">  
                    <ItemTemplate>  
                        <asp:Label ID="r" runat="server" Text='<%#Eval("status") %>'></asp:Label>  
                    </ItemTemplate>  
                    <EditItemTemplate>  
                    ...
                    <ItemTemplate>  
                        <asp:Label ID="re" runat="server" Text='<%#Eval("remarks") %>'></asp:Label>  
                        </ItemTemplate>
                             <EditItemTemplate>
           ...
           <br />
           <asp:Button Text="Back" runat="server" CssClass="btn btn-primary" ID="Bkbtn" OnClick="Bkbtn_Click" />
           </div>
